...
description: "A bird image segmentation model using U-Net, trained on the CUB-200-2011 dataset."
summary: "A bird image segmentation model using U-Net, trained on the CUB-200-2011 dataset."
